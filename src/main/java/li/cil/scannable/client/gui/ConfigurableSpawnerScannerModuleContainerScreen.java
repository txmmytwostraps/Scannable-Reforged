...
public final class ConfigurableSpawnerScannerModuleContainerScreen extends ConfigurableEntityScannerModuleContainerScreen {
    // Param is the wider EntityModuleContainerMenu (the runtime instance is a SpawnerModuleContainerMenu)
    // so the menu-screen registration's generics line up with this screen's MenuAccess type.
