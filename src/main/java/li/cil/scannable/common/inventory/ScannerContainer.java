...
public final class ScannerContainer extends SimpleContainer {
    ...
    public ScannerContainer(final ItemStack container) {
        ...
        if (contents != null) {
            final NonNullList<ItemStack> items = NonNullList.withSize(getContainerSize(), ItemStack.EMPTY);
    ...
    public void setChanged() {
        ...
        this.container.set(ModDataComponents.MODULES.get(), ItemContainerContents.fromItems(items));
    }
